...
**Link to latest draft of dissertation**: [Draft as of July 1, 2026](/assets/KCC_Dissertation.pdf)
...
Ultimately, this work demonstrates that by actively engaging with and exploiting the social context of a human-robot interaction, robots can leverage more feedback from non-expert users without increasing human teaching burden during human-robot collaborations.
